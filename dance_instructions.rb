...
def bob_the_reins
  ...
  puts "Lift your arms up and down in a loose bouncing movement, in time with the beat of the song. Do this 7 more times!"
end
...
def lasso
  ...
  puts "Raise right forearm so that it points straight up, and whip it in small circles to the beat of the song, as if you were a cowboy holding a rope lasso. Do this 7 more times!"
end
